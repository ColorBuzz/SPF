...
/////
    ...
    private void updateItemState(ViewHolderMultiChoice holder,int id){
        ...
        switch ((( MaterialCheckableListViewHolder) holder).flipView.getCurrentFlipState()){
                      ...
                      switch (item.getItemId()){
                          ...
                          case R.id.action_edit:
                              ...
                              if(actionListener!=null){
                                  ...
                                  long[] posArray=new long[1];
                                  posArray[0]=position;

                                  actionListener.toEdit(posArray);
                    ...
                    public void onClick(View v, int position, boolean isLongClick) {
                        ...
                        if(isLongClick){
                            ...
                            if(holder.isMultiChoiceActive()){
                                ...
                                dataset.updateSparseState(position, ((MaterialCheckableListViewHolder) holder).flipView.isBackSide());
                            }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_edit:
                ...
                if(multiChoiceHelper.getCheckedItemCount()==1) {
                    ...
                    long[] pos=new long[1];
                          pos[0]= multiChoiceHelper.getCheckedItemPositions().keyAt(index);
