...
public class PiecePreviewPopUp extends  DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View promptsView = li.inflate(R.layout.animated_info_container, null);
        ...
        toolbar=promptsView.findViewById(R.id.appbar2);
    ...
    public void onStart() {
        ...
        Dialog d = getDialog();
            ...
            if (d!=null && start) {
                ...
                int width =ViewGroup.LayoutParams.MATCH_PARENT; //(getActivity()).getWindowManager().getDefaultDisplay().getWidth();
                int height =ViewGroup.LayoutParams.MATCH_PARENT; //(getActivity()).getWindowManager().getDefaultDisplay().getHeight();



                FrameLayout imageContainer = (FrameLayout) d.findViewById(R.id.di);
    ...
    public void showShare(){
        ...
        titleText.setText(getResources().getString(R.string.action_save_as));
    ...
    private boolean saveImageToExternalStorage(Bitmap finalBitmap) {
        ...
        ModelDataBase db=new ModelDataBase(getContext());
        final PreviewModelInfo model=db.getPreviewModelById(getArguments().getInt(MODEL_ID));
