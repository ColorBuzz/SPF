...
public class ShapeGenerator {
    ...
    public static Bitmap getShapeBitmap(@Nullable Bitmap scaleBitmapImage, int mode, int width,int height) {
    ...
    public static Drawable getShape(Context context, int mode, int width,int height, int color) {
    ...
    public static Drawable getShapeDrawable(Context context, Drawable scaleDrawble, int mode, int width,int height) {
        ...
        Bitmap targetBitmap = Bitmap.createBitmap(targetWidth,
                targetHeight, Bitmap.Config.ARGB_8888);
        if (scaleDrawble == null) {

            return null;
        }else{

            scaleBitmapImage=ShapeGenerator.getBitmapFromVectorDrawable(scaleDrawble);
        }
    ...
    public static Drawable getImageForSpinner(Context context,Drawable drawable,int mode){

        return  new BitmapDrawable(context.getResources(),getShapeBitmap(DrawableToBitmap(drawable),mode, (int) context.getResources().getDimension(R.dimen.profile_pic_small_size), (int) context.getResources().getDimension(R.dimen.profile_pic_small_size)));
