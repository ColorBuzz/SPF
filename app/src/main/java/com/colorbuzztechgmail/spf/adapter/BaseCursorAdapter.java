...
public abstract class BaseCursorAdapter extends CursorRecyclerAdapter<ViewHolderMultiChoice> implements MultiChoiceHelper.MultiChoiceModeListener ,HeaderItemDecoration.StickyHeaderInterface {
    ...
    public static final int PIECE_ITEM= 6;


    public static enum BaseCursorAdapterType{
    ...
    private BaseCursorAdapterType adapterType;
    ...
    public BaseCursorAdapter(Cursor cursor, @Nullable ItemActionListener itemClickListener, AppCompatActivity ma, boolean enableMultiChoice,BaseCursorAdapterType mType) {
        super(cursor);
        setActionListener(itemClickListener);
        this.ma = ma;
        db=new ModelDataBase(ma);
        this.adapterType=mType;
    ...
    protected abstract Object getItem(Cursor cursor);
...
/////
    ...
    @Override
    public void onBindViewHolderCursor(ViewHolderMultiChoice holder, Cursor cursor) {




            if (dataset.isItemHaveHeader(getItem(cursor))) {


            }else{
                bindItem(holder,cursor);
            }


    }

    protected abstract void bindItem(ViewHolderMultiChoice holder, Cursor  mCursor);
