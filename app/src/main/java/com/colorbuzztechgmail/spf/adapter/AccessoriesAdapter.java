...
import com.colorbuzztechgmail.spf.AccesoryCheckableListViewHolder;
import com.colorbuzztechgmail.spf.Accessories;
import com.colorbuzztechgmail.spf.AccessoriesFragment;
...
public class AccessoriesAdapter extends  RecyclerView.Adapter<ViewHolderMultiChoice> implements MultiChoiceHelper.MultiChoiceModeListener, PopupMenu.OnMenuItemClickListener{
    ...
    final  public SortedList<Accessories> accesoriesList = new SortedList<>(Accessories.class, mCallback);
                ...
                if (isLongClick) {
                    ...
                    if (!multiChoiceHelper.selectionMode) {
                        ...
                        if (position != RecyclerView.NO_POSITION) {
                            ...
                            holder.updateCheckedState(accesory.getId());
                                ...
                                if(checkedList.size()>0) {
                                    ...
                                    for(int i=0;i<checkedList.size();i++) {
                                        ...
                                        if(checkedList.valueAt(i)) {
                                           db.deleteAccessory(accesoriesList.get(checkedList.keyAt(i)).getId());
