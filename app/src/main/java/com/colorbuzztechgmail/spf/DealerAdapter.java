...
public class DealerAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public DealerAdapter(List<Dealership> headerItems, List<Dealership> contactItems, Context mcontext,DealershipFragment dealershipFragment){

        this.itemActionListener=dealershipFragment;
        this.dealershipFragment=dealershipFragment;
...
*/
    ...
    public void startSupportActionModeIfNeeded() {
        ...
        if (choiceActionMode == null) {
            ...
            choiceActionMode = ((MainActivity)dealershipFragment.getActivity()).startSupportActionMode(mCallback);
            ...
            switch (item.getItemId()) {
                ...
                case R.id.action_removeModel:
                    ...
                    if(itemActionListener!=null)
                        itemActionListener.toRemove(itemSparse);
                ...
                case R.id.action_edit:
                    ...
                    if(checkedItemCount==1) {
                        ...
                        if(itemActionListener!=null) {
                            ...
                            id[0] =contactlist.get(itemSparse.indexOfValue(true)).getId();
                             itemActionListener.toEdit(id);
                        }
                    }else{
