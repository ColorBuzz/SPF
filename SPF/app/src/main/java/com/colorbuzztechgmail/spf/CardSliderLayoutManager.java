...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private static final int SELECTED_LAYOUT_VIEW = 0;
    ...
    private View InfoContainer;  //0 Piezas//1 Materiales

    private int selectedLayoutView;  //0 Piezas//1 Materiales
    private View biggerView=null;
    private View lastBiggerView=null;
    private int biggerPos=0;
    ...
    public View getBiggerView() {
        return biggerView;
    }

    public void setBiggerView(View biggerView) {


        this.biggerView = biggerView;
    }

    public int getBiggerPos() {
        return biggerPos;
    }

    public void setBiggerPos(int biggerPos) {
        this.biggerPos = biggerPos;
    }

    public void updateBiggerView(View v){

        if(v!=null) {

            AnimateInfoText(v,true);
    ...
    private void AnimateInfoText(View v,boolean enable) {
        ...
        if (InfoContainer != null) {
            ...
            final MaterialinfoContainer materialinfoContainer = new MaterialinfoContainer(recyclerView.getContext(),mode);
            materialinfoContainer.setView(InfoContainer);
            materialinfoContainer.startAnimation(mode, enabled, material, piece);
    ...
    public void resetBiggerView(View v) {


    }

    public void infoVisibility(boolean enabled){
    ...
    public View getLastBiggerView() {
        return lastBiggerView;
    }

    public void setLastBiggerView(View lastBiggerView) {
        this.lastBiggerView = lastBiggerView;
    }
    ...
    public CardSliderLayoutManager(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int selectedLayoutView=SELECTED_LAYOUT_VIEW;

        if (attrs == null) {
            initialize(defaultActiveCardLeft, defaultCardWidth, defaultCardsGap, null,selectedLayoutView,null);
        } else {
            int attrCardWidth;
            ...
            initialize(attrActiveCardLeft, attrCardWidth, attrCardsGap, viewUpdater,selectedLayoutView,null);
        }
    }
     ...
     */
    public CardSliderLayoutManager(int activeCardLeft, int cardWidth, float cardsGap,int selectedLayoutView,View InfoContainer) {
        initialize(activeCardLeft, cardWidth, cardsGap, null,selectedLayoutView,InfoContainer);
    }

    private void initialize(int left, int width, float gap, @Nullable ViewUpdater updater, int selectedLayoutView,View InfoContainer) {
        ...
        this.cardsGap = gap;
        this.selectedLayoutView=selectedLayoutView;
    ...
    public int getActiveCardPosition() {
        if (scrollRequestedPosition != RecyclerView.NO_POSITION) {
            ...
            if (biggestView != null) {
                ...
                if(biggestView!=getBiggerView()) {



                        resetBiggerView(getBiggerView());


                    setBiggerView(biggestView);
