...
public class ViewHolderMultiChoice1 extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener{
        ...
        public ViewHolderMultiChoice1(ViewDataBinding itemsBinding, int mode) {
