...
public class ModelListAdapter extends RecyclerView.Adapter<ViewHolderMultiChoice>implements MultiChoiceHelper.MultiChoiceModeListener ,HeaderItemDecoration.StickyHeaderInterface {
    ...
    public ModelListAdapter(@Nullable ItemActionListener itemClickListener, MainActivity ma) {
    ...
    public ViewHolderMultiChoice onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType){
            ...
            case ITEM:
                ...
                return ModelCheckableListViewHolder.create(parent);
            ...
            for (int i = dataset.size() - 1; i >= headerPos; i--) {
                ...
                if (!isHeader(i)) {
                    ...
                    switch (dataset.getSortType()){
                        ...
                        case "LAST":
                            if (((PreviewModelInfo)dataset.getObject(i)).getDate().contains(header.getTitle())) {

                               deleteIdBuffer.add(((PreviewModelInfo)dataset.getObject(i)).getId());
                        ...
                        case "NAME":
                            ...
                            final String first=((PreviewModelInfo)dataset.getObject(i)).getName().toLowerCase();
                            ...
                            }else if ((((PreviewModelInfo)dataset.getObject(i)).getName().substring(0,1)).toLowerCase().equals(header.getTitle().toLowerCase())) {
                        ...
                        case "CATEGORY":
                            if ((((PreviewModelInfo)dataset.getObject(i)).getCategory()).toLowerCase().equals(header.getTitle().toLowerCase())) {
