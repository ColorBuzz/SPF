...
public class SPFdecoder {
    ...
    private void FilterData(List<String> StringList) {
       ...
       data.addAll(StringList);
        ...
        hs = new HashSet();
        hs.addAll(sizeList); // demoArrayList= name of arrayList from which u want to remove duplicates
        sizeList.clear();
        sizeList.addAll(hs);
    ...
    private void extraData(Piece piece){
        ...
        piece.setAmount_material((drawView.decoder.calculateArea()/1000000)*10.746f);
    }
