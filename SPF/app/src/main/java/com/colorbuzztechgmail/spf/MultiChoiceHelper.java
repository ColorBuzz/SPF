...
public class MultiChoiceHelper {
    ...
    public void setItemChecked(int itemId,int position, boolean value, boolean notifyChanged) {
        // Start selection mode if needed. We don't need to if we're unchecking something.
        if (value) {
            startSupportActionModeIfNeeded();
        }

        boolean oldValue = checkStates.get(itemId);
    ...
    public void toggleItemChecked(int itemId,int position, boolean notifyChanged) {
   ...
   public void startSupportActionModeIfNeeded() {
    ...
    void resetCheckPosition(ArrayList<Integer> ids){
