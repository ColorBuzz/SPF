...
public class AddAccessoriesPopUp extends BaseDialogFragment<AddAccessoriesPopUp.OnDialogFragmentClickListener> implements  View.OnClickListener ,PopupMenu.OnMenuItemClickListener {
    ...
    public interface OnDialogFragmentClickListener {
        public void onOkClicked(AddAccessoriesPopUp dialog, Material customMaterial, boolean editable);
        public void onCancelClicked(AddAccessoriesPopUp dialog);
    ...
    public static AddAccessoriesPopUp newInstance(Integer Id, boolean editable) {
        AddAccessoriesPopUp frag = new AddAccessoriesPopUp();
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(d!=null){
                    ...
                    getActivityInstance().onCancelClicked(AddAccessoriesPopUp.this);
    ...
    private  void saveMaterial(){
        ...
        if (name != null) {
            ...
            getActivityInstance().onOkClicked(AddAccessoriesPopUp.this, customMaterial, editable);
        }else{
